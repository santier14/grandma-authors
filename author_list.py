...
{'name': 'Z.~Benkhaldoun', 'affiliations': ["Oukaimeden Observatory,High Energy Physics and Astrophysics Laboratory, FSSM, Cadi Ayyad University  Av. Prince My Abdellah, BP 2390 Marrakesh, Morocco"], 'email': 'zouhair@uca.ac.ma'},
...
{'name': 'T.~Dietrich', 'affiliations': ['Institute for Physics and Astronomy, University of Potsdam, Haus 28, Karl-Liebknecht-Str. 24/25, 14476, Potsdam, Germany', 'Max Planck Institute for Gravitational Physics (Albert Einstein Institute), Am M\"{u}hlenberg 1, Potsdam 14476, Germany'], 'email': 'tim.dietrich@uni-potsdam.de'},
...
{'name': 'N.~Kochiashvili', 'affiliations': ['E. Kharadze Georgian National Astrophysical Observatory, Mt.Kanobili, Abastumani, 0301, Adigeni, Georgia'], 'email': 'nino.kochiashvili@ILIAUNI.EDU.GE'}, {'name': 'A.~Kaeouach', 'affiliations': ['Oukaimeden Observatory (HAO), Oukaimeden,  Morocco'], 'email': 'aziz5200@live.com'},
...
{'name': 'P.T.H.~Pang', 'affiliations': ['Nikhef, Science Park 105, 1098 XG Amsterdam, The Netherlands', 'Institute for Gravitational and Subatomic Physics (GRASP), Utrecht University, Princetonplein 1, 3584 CC Utrecht, The Netherlands'], 'email': 'thopang@nikhef.nl'},
...
{'name': 'Y.~Rajabov', 'affiliations': ['Ulugh Beg Astronomical Institute, Uzbekistan Academy of Sciences, Astronomy str. 33, Tashkent 100052, Uzbekistan'], 'email': 'rajabov@ASTRIN.UZ'}, {'name': 'C.~Rinner', 'affiliations': ['Oukaimeden Observatory (MOSS), Oukaimeden,  Morocco'], 'email': 'claudine.rinner@laposte.net'},
